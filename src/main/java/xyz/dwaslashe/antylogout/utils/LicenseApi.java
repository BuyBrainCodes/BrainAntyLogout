...
public class LicenseApi {
	...
	public LicenseApi(String licenseKey, String validationServer, Plugin plugin) {
		this.licenseKey = licenseKey;
		this.plugin = plugin;
		this.validationServer = validationServer;
	}

	public LicenseApi setSecurityKey(String securityKey) {
		this.securityKey = securityKey;
		return this;
	}

	public LicenseApi setConsoleLog(LogType logType) {
		this.logType = logType;
		return this;
	}

	public LicenseApi debug() {
		debug = true;
		return this;
	}
